        ...
        Else
            ...
            If Me.Text = "Registro de Pacientes" Or Me.Text = "Registro de Pacientes - Laboratorio" Then
                ...
                Else
                    ...
                    Call Query.Insertar_Pacientes(TxtIdentidad.Text, TxtPaciente.Text, TxtEmail.Text, TxtDireccion.Text, telefono, TxtFecha.Text, TxtEdad.Text, TxtSexo.Text, ConvertImage.ImageToByteArray(PicFoto.Image))
            ...
            ElseIf Me.Text = "Editar Paciente" Or Me.Text = "Editar Paciente - Laboratorio" Then
            ...
            If IBien And EBien Then
                Call Query.Editar_Pacientes(LblId.Text, TxtIdentidad.Text, TxtPaciente.Text, TxtEmail.Text, TxtDireccion.Text, TxtTelefono.Text, TxtFecha.Text, TxtEdad.Text, TxtSexo.Text, ConvertImage.ImageToByteArray(PicFoto.Image))
