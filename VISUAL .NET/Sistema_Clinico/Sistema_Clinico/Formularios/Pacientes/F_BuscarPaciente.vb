...
Public Class F_BuscarPaciente
    ...
    Private Sub DataGridView1_CellMouseDoubleClick(sender As Object, e As DataGridViewCellMouseEventArgs) Handles DataGridView1.CellMouseDoubleClick
        ...
        If Me.Text = "Buscar Paciente - Citas" Then

            F_AgregarCita.TxtIdentidad.Text = DataGridView1.SelectedCells(2).Value.ToString()
            F_AgregarCita.TxtPaciente.Text = DataGridView1.SelectedCells(1).Value.ToString()
            F_AgregarCita.TxtTelefono.Text = DataGridView1.SelectedCells(3).Value.ToString()
            F_AgregarCita.TxtObservaciones.Focus()


        ElseIf Me.Text = "Buscar Paciente - Documentos" Then
