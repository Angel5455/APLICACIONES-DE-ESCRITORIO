...
Public Class Crys_Etiquetas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IHCAFE.Crys_Etiquetas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_Etiquetas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_Etiquetas = New Crys_Etiquetas()
        rpt.Site = Me.Site
        Return rpt
    End Function
