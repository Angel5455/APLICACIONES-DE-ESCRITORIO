...
Public Class F_Busqueda_Fases

    Dim ruta As String = ""
    Dim rpt As New ReportDocument
    Public fase As Integer : Dim strfase As String
  Dim prmdatos As ParameterField
    ...
    Private Sub F_Busqueda_Fases_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
