...
Public Class RPTtelefonico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AgendaE.RPTtelefonico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRPTtelefonico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RPTtelefonico = New RPTtelefonico
        rpt.Site = Me.Site
        Return rpt
    End Function
