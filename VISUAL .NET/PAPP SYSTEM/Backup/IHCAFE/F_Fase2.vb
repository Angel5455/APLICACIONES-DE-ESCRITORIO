...
Public Class F_Fase2
    ...
    Public Ruta As String = Application.StartupPath + "/Fase2.accdb"

    Dim n As Integer = 0


    Dim CN As New OleDb.OleDbConnection("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data SOURCE=C:\ARCHIVOS DE PROGRAMA\ARP\IHCAFE SYSTEM\Fase2.accdb")
    ...
    Private Sub F_Fase2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Bloquear()
        mostrar()
    ...
    Private Sub txtDesembolso_KeyPress(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        If Char.IsLetter(e.KeyChar) Then
    ...
    Private Sub txtDesembolso_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
    ...
    Private Sub btnNuevo_MouseEnter1(ByVal sender As Object, ByVal e As System.EventArgs) Handles btnNuevo.MouseEnter
        btnNuevo.Height = 45
        btnNuevo.Width = 45
    End Sub
