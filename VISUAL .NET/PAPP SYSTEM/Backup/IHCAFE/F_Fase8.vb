...
Public Class F_Fase8
    ...
    Dim n As Integer = 0
    Public Ruta As String = Application.StartupPath + "/Fase8.accdb"

    Dim CN As New OleDb.OleDbConnection("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data SOURCE=C:\ARCHIVOS DE PROGRAMA\ARP\IHCAFE SYSTEM\Fase8.accdb")
    ...
    Private Sub F_Fase8_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Bloquear()
        mostrar()

        txtN.Text = 1

        txtid.Text = My.Settings.MyId8
