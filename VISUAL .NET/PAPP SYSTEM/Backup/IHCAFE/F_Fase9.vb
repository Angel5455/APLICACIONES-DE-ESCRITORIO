...
Public Class F_Fase9
    ...
    Dim n As Integer = 0
    Public Ruta As String = Application.StartupPath + "/Fase9.accdb"

    Dim CN As New OleDb.OleDbConnection("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data SOURCE=C:\ARCHIVOS DE PROGRAMA\ARP\IHCAFE SYSTEM\Fase9.accdb")
    ...
    Private Sub F_Fase9_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Bloquear()
        mostrar()
