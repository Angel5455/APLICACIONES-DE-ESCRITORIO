...
Public Class F_Fase1
    ...
    Dim n As Integer = 0
    Public Ruta As String = Application.StartupPath + "/Fase1.accdb"
    ...
    Private Sub txtN2_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)
