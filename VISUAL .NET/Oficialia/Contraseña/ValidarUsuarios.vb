...
Public Class ValidarUsuarios
    ...
    Public Function Comprobar_Users(ByVal s As String) As String
        ...
        Try
            ...
            Dim consulta As New SqlCommand("Select * from Seguridad where Usuario ='" & s & "'", Conexion.conexion)
    ...
    Public Function Comprobar_Pass(ByVal s As String) As String
        ...
        Try
            Conexion.conexion.Open()
            Dim consulta As New SqlCommand("Select Contraseña from Seguridad where Usuario ='" & s & "'", Conexion.conexion)
