...
Public Class CrysCreditosR
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CREATIVOS.CrysCreditosR.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysCreditosR
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysCreditosR = New CrysCreditosR()
        rpt.Site = Me.Site
        Return rpt
    End Function
