...
Public Class Conexion_Descripcion
    ...
    Public Function borrar_datos_descripcion(ByVal datos As dDescripcion) As Boolean
        ...
        Try
            ...
            conexion()
            _adaptador.DeleteCommand = New SqlCommand("Delete from Descripcion where Ticket=@Ticket and Descripcion=@Descripcion", _conexion)
            _adaptador.DeleteCommand.Parameters.Add("@Descripcion", SqlDbType.VarChar, 50).Value = datos.descripcion
            _adaptador.DeleteCommand.Parameters.Add("@Ticket", SqlDbType.Int).Value = datos.ticket
