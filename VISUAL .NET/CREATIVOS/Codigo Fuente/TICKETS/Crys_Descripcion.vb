...
Public Class Crys_Descripcion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CREATIVOS.Crys_Descripcion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_Descripcion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_Descripcion = New Crys_Descripcion()
        rpt.Site = Me.Site
        Return rpt
    End Function
