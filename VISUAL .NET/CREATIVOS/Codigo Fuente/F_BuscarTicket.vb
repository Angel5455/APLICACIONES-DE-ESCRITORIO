...
Public Class F_BuscarTicket
    ...
    Private Sub llenarDsReporteTickets(ByVal strruta As String)
        ...
        Try
            ...
            ta.FillByTicket(mids.Tickets, ComboBox1.Text, txtticket.Text)
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        datos.nombre = ComboBox1.Text

        If conexion.consultar_ticket(datos) Then
    ...
    Private Sub ComboBox1_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles ComboBox1.SelectedIndexChanged
        ...
        Dim da As New SqlDataAdapter("Select * from Tickets Where Nombre like'" & ComboBox1.Text & "%'", con)
