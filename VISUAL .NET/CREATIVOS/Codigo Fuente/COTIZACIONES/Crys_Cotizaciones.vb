...
Public Class Crys_Cotizaciones
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CREATIVOS.Crys_Cotizaciones.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_Cotizaciones
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_Cotizaciones = New Crys_Cotizaciones()
        rpt.Site = Me.Site
        Return rpt
    End Function
