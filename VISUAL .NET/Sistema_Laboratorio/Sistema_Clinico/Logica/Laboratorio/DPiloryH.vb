Public Class DPiloryH
    ...
    Function Id() As Integer
        Try
            Query = (From n In Conexion.HPilory_Heces Select n).Count
    ...
    Public Sub Guardar_Examen(ByVal Identidad As String, ByVal Paciente As String, ByVal Edad As Integer, ByVal Sexo As String, ByVal Referencia As String, ByVal Muestra As Integer, ByVal Fecha As String, ByVal Resultado As String, ByVal Nota As String)
        ...
        'Servicionuevo.Id = id
        Dim Servicionuevo As New HPilory_Heces With {
            .Identidad = Identidad,
            .Paciente = Paciente,
            .Edad = Edad,
            .Sexo = Sexo,
        ...
        Conexion.HPilory_Heces.InsertOnSubmit(Servicionuevo)
