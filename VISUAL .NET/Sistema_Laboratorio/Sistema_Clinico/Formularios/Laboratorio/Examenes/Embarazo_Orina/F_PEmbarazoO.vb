...
Public Class F_PEmbarazoO
    ...
    Dim ID As String
    Public WithEvents Query As New DPEmbarazoO
    Dim ConexionLINQ As New DataClasses1DataContext()

    Private Sub F_PEmbarazoO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub F_PEmbarazoO_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        Limpiar()
