...
Public Class CrysCotGeneral
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CREATIVOS.CrysCotGeneral.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysCotGeneral
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysCotGeneral = New CrysCotGeneral()
        rpt.Site = Me.Site
        Return rpt
    End Function
