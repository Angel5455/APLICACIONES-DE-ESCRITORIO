...
Public Class CrysEmpleados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "CREATIVOS.CrysEmpleados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysEmpleados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysEmpleados = New CrysEmpleados()
        rpt.Site = Me.Site
        Return rpt
    End Function
