...
Public Class F_Pacientes
    ...
    Private Sub BtnEditar_Click(sender As Object, e As EventArgs) Handles BtnEditar.Click
        ...
        Else
            ...
            F_AgregarPacientes.TxtIdentidad.Text = Id


            Dim Conexion As New CConexion
            Dim Sql As New DataSet

            Sql = Conexion.Consultar("SELECT * FROM Pacientes WHERE Identidad='" & Id & "'")


            Id = Sql.Tables(0).Rows(0).Item("Id")
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If resp = 6 Then
            ...
            Dim Id As String = DataGridView1.SelectedCells(1).Value.ToString()
