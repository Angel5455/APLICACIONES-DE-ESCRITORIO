...
Public Class CrysPEspeciales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinico.CrysPEspeciales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysPEspeciales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysPEspeciales = New CrysPEspeciales()
        rpt.Site = Me.Site
        Return rpt
    End Function
