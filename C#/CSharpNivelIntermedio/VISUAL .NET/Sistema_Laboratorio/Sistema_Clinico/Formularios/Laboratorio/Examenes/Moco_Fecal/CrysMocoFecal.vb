...
Public Class CrysMocoFecal
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinico.CrysMocoFecal.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysMocoFecal
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysMocoFecal = New CrysMocoFecal()
        rpt.Site = Me.Site
        Return rpt
    End Function
