...
Public Class CrysCitologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinico.CrysCitologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysCitologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysCitologia = New CrysCitologia()
        rpt.Site = Me.Site
        Return rpt
    End Function
