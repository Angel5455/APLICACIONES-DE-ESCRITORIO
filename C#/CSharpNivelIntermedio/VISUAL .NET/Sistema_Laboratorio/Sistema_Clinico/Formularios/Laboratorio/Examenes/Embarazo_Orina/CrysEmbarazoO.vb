...
Public Class CrysEmbarazoO
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinico.CrysEmbarazoO.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysEmbarazoO
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysEmbarazoO = New CrysEmbarazoO()
        rpt.Site = Me.Site
        Return rpt
    End Function
