...
Public Class CrysHematologia
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinico.CrysHematologia.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysHematologia
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysHematologia = New CrysHematologia()
        rpt.Site = Me.Site
        Return rpt
    End Function
