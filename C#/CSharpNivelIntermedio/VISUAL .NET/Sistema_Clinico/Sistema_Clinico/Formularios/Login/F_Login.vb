...
Public Class F_Login
    ...
    Private Sub IconCerrar_Click(sender As Object, e As EventArgs) Handles IconCerrar.Click
        Form1.LinkSesion.Visible = True
        Form1.LinkSesion.Text = "Iniciar Sesión"
        Me.Close()
        ...
        Try
            ...
            If funciones.Validar(dts) = True Then
                ...
                If Cargo = "Enfermera" Or Cargo = "Recepcionista" Then
                    Form1.BtnHCasos.Visible = False
                    Form1.BtnDocumentos.Visible = False
                    Form1.BtnCitas.Visible = False
                    Form1.BtnPrescripcion.Visible = False
                    Form1.BtnPLab.Visible = False
                    Form1.BtnRH.Visible = False
