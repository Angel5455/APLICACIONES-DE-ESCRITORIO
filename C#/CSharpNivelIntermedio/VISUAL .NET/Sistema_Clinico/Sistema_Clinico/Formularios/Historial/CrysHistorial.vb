...
Public Class CrysHistorial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sistema_Clinico.CrysHistorial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrysHistorial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrysHistorial = New CrysHistorial()
        rpt.Site = Me.Site
        Return rpt
    End Function
