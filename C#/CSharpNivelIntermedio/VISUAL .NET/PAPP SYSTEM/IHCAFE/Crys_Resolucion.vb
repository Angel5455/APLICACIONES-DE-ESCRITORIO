...
Public Class Crys_Resolucion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IHCAFE.Crys_Resolucion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_Resolucion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_Resolucion = New Crys_Resolucion()
        rpt.Site = Me.Site
        Return rpt
    End Function
