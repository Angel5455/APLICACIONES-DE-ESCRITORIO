...
Public Class Crys_Movimientos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IHCAFE.Crys_Movimientos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_Movimientos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_Movimientos = New Crys_Movimientos()
        rpt.Site = Me.Site
        Return rpt
    End Function
