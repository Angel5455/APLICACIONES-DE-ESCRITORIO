...
Public Class Crys_Historial
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IHCAFE.Crys_Historial.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_Historial
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_Historial = New Crys_Historial()
        rpt.Site = Me.Site
        Return rpt
    End Function
