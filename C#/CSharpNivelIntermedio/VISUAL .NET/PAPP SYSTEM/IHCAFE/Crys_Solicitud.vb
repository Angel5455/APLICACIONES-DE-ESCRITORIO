...
Public Class Crys_Solicitud
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "IHCAFE.Crys_Solicitud.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrys_Solicitud
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Crys_Solicitud = New Crys_Solicitud()
        rpt.Site = Me.Site
        Return rpt
    End Function
