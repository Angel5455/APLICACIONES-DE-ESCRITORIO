...
Public Class F_Fase5
    ...
    Public Ruta As String = Application.StartupPath + "/Fase5.accdb"
    Public Ruta2 As String = Application.StartupPath + "/Fase4.accdb"
    ...
    Dim CN As New OleDb.OleDbConnection("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data SOURCE=C:\ARCHIVOS DE PROGRAMA\ARP\IHCAFE SYSTEM\Fase5.accdb")
    ...
    Private Sub F_Fase5_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Bloquear()

        txtid.Text = My.Settings.MyId5
    ...
    Private Sub txtbuscarnombre_TextChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtbuscarnombre.TextChanged
        ...
        DataGridView1.DataMember = "DESEMBOLSO1"
