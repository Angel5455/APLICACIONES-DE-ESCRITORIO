...
Public Class F_Fase3
    ...
    Public Ruta As String = Application.StartupPath + "/Fase3.accdb"

    Dim n As Integer = 0
    Dim CN As New OleDb.OleDbConnection("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data SOURCE=C:\ARCHIVOS DE PROGRAMA\ARP\IHCAFE SYSTEM\Fase3.accdb")
    ...
    Private Sub F_Fase3_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Bloquear()
        mostrar()
