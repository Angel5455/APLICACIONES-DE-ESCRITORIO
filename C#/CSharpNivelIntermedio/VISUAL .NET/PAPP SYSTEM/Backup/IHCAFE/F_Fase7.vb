...
Public Class F_Fase7
    ...
    Public Ruta As String = Application.StartupPath + "/Fase7.accdb"
    Public Ruta2 As String = Application.StartupPath + "/Fase6.accdb"
    ...
    Dim CN As New OleDb.OleDbConnection("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data SOURCE=C:\ARCHIVOS DE PROGRAMA\ARP\IHCAFE SYSTEM\Fase7.accdb")
    ...
    End Sub
    Private Sub F_Fase7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Bloquear()
        txtN.Text = 1



        txtid.Text = My.Settings.MyId7
    ...
    Private Sub PictureBox6_MouseEnter(ByVal sender As Object, ByVal e As System.EventArgs) Handles PictureBox6.MouseEnter
        PictureBox6.Height = 45
        PictureBox6.Width = 45
    End Sub
    ...
    Private Sub txtN_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles txtN.SelectedIndexChanged
        Dim CN As New OleDb.OleDbConnection("PROVIDER=Microsoft.ACE.OLEDB.12.0;Data SOURCE=C:\ARCHIVOS DE PROGRAMA\ARP\IHCAFE SYSTEM\Fase1.accdb")
